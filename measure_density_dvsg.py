"""AEROS Phase 0 — REAL density measurement on DVS128 Gesture trained ckpt.
This is the run whose data decides AEROS go/no-go."""
import argparse, os
import numpy as np
import torch
...
# Must match train_dvsg.py exactly
...
def main():
    ...
    p.add_argument('--num_batches', type=int, default=16)  # whole test set is small
    p.add_argument('--channels', type=int, default=128)
    p.add_argument('--out', default='density_dvsg_trained.npz')
