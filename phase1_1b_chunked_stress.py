...
def main():
    ...
    # Config
    B = 32       # batch (try smaller if OOM)
    T = 128      # timesteps
    C, H, W = 3, 224, 224  # input shape (use 64x64 to save memory; later try 224)
    Ks = [128, 64, 32, 16, 8, 4, 2, 1]   # K=64 means baseline (1 chunk = full T)
